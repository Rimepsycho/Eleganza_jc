                                ...
                                <div class="card-body">
                                    <form action="doLogin.php" method="post">
                                        <div class="form-floating mb-3">
                                            <input class="form-control bg-dark text-white" name="account" type="text" placeholder="account" />
                                            <label for="account">帳號</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input class="form-control bg-dark text-white" name="password" type="password" placeholder="password" />
                                        ...
                                        <div class="form-check mb-3">
                                            <input class="form-check-input text-info" name="remember" type="checkbox" value="" />
                                            <label class="form-check-label" for="remember">記住我</label>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <a class="small nav-link text-info" href="password.php">忘記密碼?</a>
